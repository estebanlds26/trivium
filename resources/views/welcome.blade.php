        ...
        <section class="bottom">
            ...
            <article class="relevant">
                ...
                <template x-if="section == 'products'">
                    ...
                    <section id="products" x-ref="products" class="relevant-content" @scroll="handleInnerScroll($el)" x-data="productos">
                        <template x-if="showProductDetail">
                            <div class="product-detail">
                                <div class="slideshow-container" @mousemove="appearControls"
                        ...
                        <template x-for="product in products" :key="product.id">
                            <div x-data="producto" class="product-container">
                                <article class="product" @click="setProductDetail(product)">
                                    ...
                                    <div class="info">
                                        <div class="left"><span class="price"
                                                x-text="`$ ${product.price}`"></span></div>
                                        <div class="right">
                                            <input type="number" x-model="quantity" name="quantity"
                                                class="quantity" value="1" autocomplete="off">
